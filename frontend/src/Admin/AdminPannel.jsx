...
import CreateCategoryForm from "./componets/create/CreateCategoryForm";
import CreateSubCategoryForm from "./componets/create/CreateSubCategoryForm";
...
const menu = [
  ...
  {name:"Add SubCategory",path:"/admin/subcategory/create"},
];
      ...
      <Box sx={{ display: `${isLargeScreen ? "flex" : "block"}` }}>
        ...
        <Box className="adminContainer" component="main" sx={{ flexGrow: 1 }}>
          ...
          <Routes>
            ...
            <Route path="/subcategory/create" element={<CreateSubCategoryForm/>}></Route>
